...
<meta charset="UTF-8">
    ...
    <title>Healhico</title>
</head>

<body>
    <!-- start navbar                 bg-danger-->
    <nav class="navbar navbar-expand-sm navbar-dark  fixed-top">
        <a href="index.php" class="navbar-brand">Healthico</a>
    ...
    <header class="jumbotron back-img"
        ...
        <div class="introinner" style="display: block;margin-top: 142px;margin-left: 40px;">
            <h1 class="text-uppercase text-danger">Welcome to Healthico</h1>
