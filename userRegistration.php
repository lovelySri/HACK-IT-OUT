...
if(isset($_REQUEST['rSignup'])){
   ...
   $sql = "INSERT INTO `requesterlogin_tb` ( `r_name`, `r_email`, `r_age`, `r_gender`, `r_address`, `r_phone`, `r_password`) VALUES ('$rName', '$rEmail', '$rAge', '$rAddress', '$rGender', '$rPhone', '$rPassword')";
...
<div class="container pt-5" id="Registration">
  ...
  <break>
                    <div class="form-group">
                        <i class="fas fa-1x fa-user"></i>
                        <label for="text" class="font-weight-bold pl-2" style="padding:11px;">Age</label><br>
                        <input type="text" class="form-control" placeholder="Age XX" name="Age">
                        
                    </div>
            <break>
            <div class="form-group">
                        <i class="fas fa-1x fa-user"></i>
                        <label for="text" class="font-weight-bold pl-2" style="padding:11px;">Gender</label><br>
                    ...
                    <div class="form-group">
                        <i class="fas fa-1x fa-user"></i>
                        <label for="text" class="font-weight-bold pl-2" style="padding:11px;">Address</label><br>
                    ...
                    <div class="form-group">
                        <i class="fas fa-1x fa-user"></i>
                        <label for="text" class="font-weight-bold pl-2" style="padding:11px;">Phone Number</label><br>
